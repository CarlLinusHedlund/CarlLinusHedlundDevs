    ...
    return (
        <div id="header" className="bg-primaryDark z-20 px-8 md:px-0 md:py-12 sticky top-0 bottom-0 w-full h-[90px] border-b border-[#2c2c2c] md:h-screen md:w-[110px] md:border-r md:border-b-0">
            <div className="w-full h-full flex flex-row justify-between items-center md:flex-col-reverse">
                ...
                <div onClick={showNavBar} className="flex justify-center items-center h-10 duration-1000">
                    <div ref={burgerRef} className="duration-1000 bg-primaryWhite h-0.5 w-[35px] after:duration-1000 relative rounded-lg after:w-[30px] after:h-0.5 after:absolute after:rounded-lg after:top-2.5 after:bg-white before:w-[40px] before:h-0.5 before:bg-white before:rounded-lg before:absolute before:bottom-2.5" />
                </div>
            </div>
