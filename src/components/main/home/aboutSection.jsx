...
function AboutSection() {
  ...
  return(
    ...
    <div className=" max-w-5xl mx-auto px-4 xs:px-8 pb-20 min-h-[500px] ">
      ...
      <div className=" htmlTags before:content-['<div>'] after:content-['</div>'] flex flex-col gap-3 relative pl-2 ml-1 py-4 my-20 mb-10 md:after:text-sm md:before:text-sm">
        <h2 ref={el} className=" pl-1 md:pl-3 py-1 md:py-3 relative htmlTags before:content-['<h2>'] after:content-['</h2>'] min-h-[32px] md:min-h-[44px] leading-5 font-rubik font-bold text-[22px] xxs:text-[27px] xs:text-[33px] sm:text-[35px] md:text-[45px] text-primaryCoral md:after:text-sm md:before:text-sm "></h2>
        <p className=" pl-1 md:pl-3 py-0 sm:py-1 relative htmlTags before:content-['<p>'] after:content-['</p>'] text-textXS md:text-textSM font-rubik font-normal md:font-light leading-4 max-w-sm md:max-w-lg md:after:text-sm md:before:text-sm ">
      ...
      <div className="ml-2 py-2 max-w-xs htmlTags relative before:content-['<button\00a0href=/about>'] after:content-['</button>'] lg:hover:hoverShadowDark duration-300 md:after:text-sm md:before:text-sm md:py-4 ">
